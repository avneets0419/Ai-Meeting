...
export function RecentMeetings() {
  ...
  return (
    <div className="py-4 flex items-start flex-col">
    <h3 className="font-readex text-[26px] font-semibold leading-none tracking-tight py-2 pb-4 px-2">Recent Summaries</h3>
      <AnimatePresence>
