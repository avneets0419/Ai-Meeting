...
export function TestimonialsSection({
  ...
  return (
    <section
      className={cn("dark bg-background text-foreground", "py-12 sm:py-24 md:py-32 px-0", className)}>
      <div
        className="mx-auto flex max-w-container flex-col items-center gap-4 text-center sm:gap-16">
        <div className="flex flex-col items-center gap-4 px-4 sm:gap-8">
          <h2
            className=" font-readex max-w-[720px] text-3xl font-semibold leading-tight sm:text-5xl sm:leading-tight">
            {title}
          </h2>
          <p
            className=" font-readex text-md max-w-[600px] font-medium text-muted-foreground sm:text-xl">
            {description}
          </p>
        </div>
