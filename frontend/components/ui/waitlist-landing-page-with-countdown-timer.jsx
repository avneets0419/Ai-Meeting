                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="mb-6">
                      <div className="flex gap-3">
                        ...
                        <Button
                          type="submit"
                          className="h-12 px-6 bg-purple-500 hover:bg-purple-600 text-white font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-purple-400/25"
                        >
                          Get Notified
                        </Button>
                      </div>
